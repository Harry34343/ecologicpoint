...
final List<TipData> _unlockedTips = [
  ...
  TipData(
    ...
    description: 'Los aparatos en standby consumen energía. ¡Desenchúfalos!',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/plantas/cactus.svg',
    title: 'Menos Carne, Más Planeta',
    description:
        'Reducir el consumo de carne disminuye tu huella hídrica y de carbono.',
    isSvg: true,
  ),
  TipData(
    ...
    description:
        'Camina, usa bici o transporte público para reducir emisiones.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/armarioicon.svg',
    title: 'Moda Consciente',
    description: 'Opta por ropa de segunda mano o marcas sostenibles.',
    isSvg: true,
  ),
  TipData(
    ...
    title: 'Compra Local',
    description:
        'Apoya a los productores locales y reduce el transporte de alimentos.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/sombrero.svg',
    title: 'Reutiliza y Repara',
    description:
        'Antes de desechar, piensa si puedes darle una segunda vida o arreglarlo.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/plantas/girasol.svg',
    title: 'Biodiversidad en Casa',
    description:
        'Planta flores nativas para atraer polinizadores a tu jardín o balcón.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/logo.svg',
    title: 'Papel Inteligente',
    description: 'Imprime a doble cara y recicla todo el papel que puedas.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/gota.svg',
    title: 'Fugas Silenciosas',
    description:
        'Revisa periódicamente grifos e inodoros para detectar fugas de agua.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/botella.svg',
    title: 'Evita los Microplásticos',
    description:
        'Elige cosméticos y ropa sin microplásticos que contaminan el agua.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/logo2.svg',
    title: 'Luz Natural al Máximo',
    description: 'Aprovecha la luz del día y reduce el uso de luz artificial.',
    isSvg: true,
  ),
  TipData(
    ...
    description:
        'Transforma tus residuos orgánicos en abono nutritivo para tus plantas.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/phplantduotone.svg',
    ...
    description:
        'Mantén la velocidad constante y evita acelerones para ahorrar combustible.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/armarioicon.svg',
    ...
    description:
        'La ropa, libros o juguetes en buen estado pueden servir a otros.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/tiendaicon.svg',
    ...
    description:
        'Planifica tus compras, aprovecha las sobras y conserva bien los alimentos.',
    isSvg: true,
  ),
  TipData(
    iconAssetPath: 'assets/sombrero.svg',
    title: 'Educación Ambiental Continua',
    description:
        'Sigue aprendiendo sobre sostenibilidad y comparte tus conocimientos.',
    isSvg: true,
  ),
  TipData(
    ...
    description:
        'Cada gesto cuenta en la construcción de un futuro más sostenible.',
    isSvg: true,
  ),
];
// --- FIN DE DATOS ---
