...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const String userAvatarAsset = 'assets/plantas/bambu.svg'; // O la planta actual del usuario
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFFF7F6EA), // Fondo de AppBar igual al body
        elevation: 0,
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: const Color(0xFFD4ECDD).withOpacity(0.7), // Fondo claro para el círculo
                  border: Border.all(color: const Color(0xFFA8C686), width: 3), // Borde verde
                ),
                child: ClipOval(
                  child: SvgPicture.asset(
                    userAvatarAsset,
                    fit: BoxFit.contain, // O BoxFit.cover si la imagen no es perfectamente circular
                  ),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Icon(Icons.copy_outlined, color: Colors.grey.shade600, size: 18),
                ],
              ),
              ...
              Row(
                children: [
                  Expanded(child: _buildStatCard('assets/bolas.svg', userStreak.toString(), userStreakUnit, isStreak: true)),
                  const SizedBox(width: 16),
                  Expanded(child: _buildStatCard('assets/logo.svg', userEcoPoints.toString(), 'EcoPoints')),
                ],
              ),
              ...
              ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(color: Colors.red.shade700, width: 1.5), // Borde rojo
                  ),
  ...
  Widget _buildStatCard(String iconAssetPath, String value, String label, {bool isStreak = false}) {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          SvgPicture.asset(iconAssetPath, width: 28, height: 28,
           colorFilter: isStreak ? ColorFilter.mode(const Color(0xFFEE8E00), BlendMode.srcIn) : ColorFilter.mode(const Color(0xFF355E3B), BlendMode.srcIn)
          ),
          ...
          if(isStreak) Text("Racha", style: _poppins(FontWeight.w400, 10, Colors.grey.shade600)), // Texto "Racha" pequeño si es necesario (como en la imagen)
  ...
  Widget _buildProfileOptionItem({required IconData icon, required String text, required VoidCallback onTap}) {
    return InkWell(
      onTap: onTap,
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon, color: const Color(0xFF355E3B), size: 22), // Icono verde oscuro
            const SizedBox(width: 16),
            Expanded(
              child: Text(
                text,
            ...
            SvgPicture.asset('assets/buttonflecha.svg', width: 16, height: 16, colorFilter: ColorFilter.mode(Colors.grey.shade600, BlendMode.srcIn)),
          ],
        ),
      ),
    );
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Expanded(child: _bottomNavItem(context, icon: Icons.map_outlined, label: 'Mapa', isSelected: currentIndex == 1, onTap: () { /* Nav a Mapa */ })),
            ...
            Expanded(child: _bottomNavItem(context, icon: Icons.person_outline, label: 'Perfil', isSelected: currentIndex == 3, onTap: () { /* Ya estamos en Perfil */ })),
          ],
        ),
      ),
    );
