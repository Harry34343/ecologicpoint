...
void main() {
  ...
  runApp(
    MultiProvider( // PASO 1: Envolver la App con MultiProvider
      providers: [
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData.dark().copyWith(
        ...
        scaffoldBackgroundColor: const Color(0xFFF7F6EA), // Color de fondo más claro de EcologicPoint
        colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFF355E3B)).copyWith(
        ...
        appBarTheme: const AppBarTheme( // Para consistencia en AppBars
      ...
      routes: {
        '/welcome': (context) => const WelcomePage(), // Asegúrate que WelcomePage sea const si no cambia
        '/login': (context) => const LogIn(),         // Asegúrate que LogIn sea const si no cambia
        '/home': (context) => const HomeScreen(),
        '/createacc': (context) => const CreateAcc(), // Asumo que es CreateAccountScreen
